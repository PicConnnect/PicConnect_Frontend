    ...
    return (
        <div class="userProfileContainer">
          <div className='userProfileImageContainer'>
            ...
            {isEditingImage ? (
                <div>
                    <button className="editButton" onClick={saveImage}>Save</button>
                    <button className="editButton" onClick={cancelImageEdit}>Cancel</button>
                </div>
            ) : 
            <button className="editButton" onClick={makeImageEditable}>Edit</button>
}
          </div>
          <br></br>
          {/* here */}
